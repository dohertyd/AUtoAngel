...
+ (NSString *)genJSONTag:(NSString *)tag;
+ (NSString *)encodeJSString:(NSString *)str;
...
#define GOLGI_PREREG_OPTION "PREREG"
#define GOLGI_ONE_TIME_REG_TOKEN_OPTION "ONE_TIME_REG_TOKEN"
#define GOLGI_PUSH_TX_TS_OPTION "PUSH_TX_TS"
#define GOLGI_PUSH_RX_TS_OPTION "PUSH_RX_TS"
#define GOLGI_DEVICE_TS_OPTION "DEVICE_TS"
#define GOLGI_APNS_ALERT_MESSAGE_OPTION "APNS_ALERT_MESSAGE"
#define GOLGI_APNS_BADGE_NUMBER_OPTION "APNS_BADGE_NUMBER"
#define GOLGI_APNS_SOUND_NAME_OPTION "APNS_SOUND_NAME"
...
//  JSONLib
//
//  Created by Brian Kelly on 12/15/14.
//  Copyright (c) 2014 Golgi. All rights reserved.
//


@class GolgiJSONValue;
@class GolgiJSONError;

@interface GolgiJSONObject : NSObject
{
    NSMutableDictionary *dict;
}

- (void)addValue:(GolgiJSONValue *)val withKey:(NSString *)key;
- (GolgiJSONValue *)getValueForKey:(NSString *)key;
- (void)dumpToString:(NSMutableString *)dst usingIndent:(NSInteger)indent;
- (NSString *)dump;
- (NSInteger)compareWith:(GolgiJSONObject *)gjo;
 
- (NSString *)getStringWithKey:(NSString *)key error:(GolgiJSONError **)err;
- (NSNumber *)getIntegerWithKey:(NSString *)key error:(GolgiJSONError **)err;
- (NSNumber *)getDoubleWithKey:(NSString *)key error:(GolgiJSONError **)err;
- (GolgiJSONObject *)getObjectWithKey:(NSString *)key error:(GolgiJSONError **)err;
- (NSArray *)getArrayWithKey:(NSString *)key error:(GolgiJSONError **)err;

+ (GolgiJSONObject *)createFromDictionary:(NSDictionary *)d error:(GolgiJSONError **)err;
+ (GolgiJSONObject *)createFromData:(NSData *)data error:(GolgiJSONError **)err;
+ (GolgiJSONObject *)createFromString:(NSString *)str error:(GolgiJSONError **)err;
...
@interface GolgiJSONValue : NSObject
{
    NSString *str;
    NSNumber *val;
    GolgiJSONObject *obj;
...
@property (readonly) NSNumber *val;
@property (readonly) GolgiJSONObject *obj;
...
- (void)dumpToString:(NSMutableString *)dst usingIndent:(NSInteger)indent;
- (NSInteger)compareWith:(GolgiJSONValue *)gjv;

+ (GolgiJSONValue *) createFromDictionaryObject:(id)obj error:(GolgiJSONError **)err;
...
@interface GolgiJSONError : NSObject
{
    NSInteger errType;
    NSString *errText;
}

@property (readonly) NSInteger errType;
@property (readonly) NSString *errText;

- (void)prependErrText:(NSString *)str;
- (void)appendErrText:(NSString *)str;

+ (GolgiJSONError *)createWithErrType:(NSInteger)errType andErrText:(NSString *)errText;
...
#define GOLGI_TEST_CONST_STRING "Mary had a little lamb"
#define GOLGI_ERRTYPE_INCORRECT_JSON 7902
#define GOLGI_ERRTYPE_MALFORMED_JSON 7901
...
- (NSString *)serialise;
+ (GolgiException *)fromJSONObject:(GolgiJSONObject *)jsonObject;
+ (GolgiException *)fromJSONString:(NSString *)jsonString;
+ (GolgiException *)fromJSONObject:(GolgiJSONObject *)jsonObject error:(GolgiJSONError **)err;
+ (GolgiException *)fromJSONString:(NSString *)jsonString error:(GolgiJSONError **)err;
- (NSString *)toJSON;
...
- (NSString *)serialiseWithPrefix:(NSString *)prefix;
- (NSString *)serialise;
+ (SSArg *)fromJSONObject:(GolgiJSONObject *)jsonObject;
+ (SSArg *)fromJSONString:(NSString *)jsonString;
+ (SSArg *)fromJSONObject:(GolgiJSONObject *)jsonObject error:(GolgiJSONError **)err;
+ (SSArg *)fromJSONString:(NSString *)jsonString error:(GolgiJSONError **)err;
- (NSString *)toJSON;
- (id)initWithIsSet:(BOOL)defIsSet;
@end
...
- (NSString *)serialiseWithPrefix:(NSString *)prefix;
- (NSString *)serialise;
+ (SSResult *)fromJSONObject:(GolgiJSONObject *)jsonObject;
+ (SSResult *)fromJSONString:(NSString *)jsonString;
+ (SSResult *)fromJSONObject:(GolgiJSONObject *)jsonObject error:(GolgiJSONError **)err;
+ (SSResult *)fromJSONString:(NSString *)jsonString error:(GolgiJSONError **)err;
- (NSString *)toJSON;
- (id)initWithIsSet:(BOOL)defIsSet;
@end
...
- (NSString *)serialiseWithPrefix:(NSString *)prefix;
- (NSString *)serialise;
+ (SimpleStringException *)fromJSONObject:(GolgiJSONObject *)jsonObject;
+ (SimpleStringException *)fromJSONString:(NSString *)jsonString;
+ (SimpleStringException *)fromJSONObject:(GolgiJSONObject *)jsonObject error:(GolgiJSONError **)err;
+ (SimpleStringException *)fromJSONString:(NSString *)jsonString error:(GolgiJSONError **)err;
- (NSString *)toJSON;
- (id)initWithIsSet:(BOOL)defIsSet;
@end
...
- (NSString *)serialiseWithPrefix:(NSString *)prefix;
- (NSString *)serialise;
+ (SimpleString_sendString_reqArg *)fromJSONObject:(GolgiJSONObject *)jsonObject;
+ (SimpleString_sendString_reqArg *)fromJSONString:(NSString *)jsonString;
+ (SimpleString_sendString_reqArg *)fromJSONObject:(GolgiJSONObject *)jsonObject error:(GolgiJSONError **)err;
+ (SimpleString_sendString_reqArg *)fromJSONString:(NSString *)jsonString error:(GolgiJSONError **)err;
- (NSString *)toJSON;
- (id)initWithIsSet:(BOOL)defIsSet;
@end
...
- (NSString *)serialiseWithPrefix:(NSString *)prefix;
- (NSString *)serialise;
+ (SimpleString_sendString_rspArg *)fromJSONObject:(GolgiJSONObject *)jsonObject;
+ (SimpleString_sendString_rspArg *)fromJSONString:(NSString *)jsonString;
+ (SimpleString_sendString_rspArg *)fromJSONObject:(GolgiJSONObject *)jsonObject error:(GolgiJSONError **)err;
+ (SimpleString_sendString_rspArg *)fromJSONString:(NSString *)jsonString error:(GolgiJSONError **)err;
- (NSString *)toJSON;
- (id)initWithIsSet:(BOOL)defIsSet;
@end
//
...
+ (void)httpSendSendStringUsingResultHandler:(void (^)(SSResult *, SimpleStringSendStringExceptionBundle *))resultHandler andDestination:(NSString *)_dst withArg:(SSArg *)arg;
